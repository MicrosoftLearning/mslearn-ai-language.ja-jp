...
Visual Studio Code を使用して Text Analytics アプリを開発します。 アプリのコード ファイルは、GitHub リポジトリで提供されています。
...
1. Visual Studio Code の **[エクスプローラー]** ペインで、**Labfiles/01-analyze-text** フォルダーを参照し、言語の設定とそこに含まれている **text-analytics** フォルダーに応じて **CSharp** または **Python** フォルダーを展開します。 各フォルダーには、Azure AI Language の Text Analytics 機能を統合するアプリの言語固有のファイルが含まれています。
2. コード ファイルを含んだ **text-analytics** フォルダーを右クリックして、統合ターミナルを開きます。 次に、言語設定に適したコマンドを実行して、Azure AI Language Text Analytics SDK パッケージをインストールします。
...
3. **[エクスプローラー]** ペインの **text-analytics** フォルダーで、優先する言語の構成ファイルを開きます。
...
1. 変更を保存します。 **text-analysis** フォルダーの統合ターミナルに戻り、プログラムを再実行します。
