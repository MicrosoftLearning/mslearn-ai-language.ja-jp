---
lab:
  title: 質問応答ソリューションを作成する (非推奨)
  description: Azure AI Language を使用して、カスタムの質問応答ソリューションを作成します。
  islab: false
---

# 質問応答ソリューションを作成する (非推奨)

> **注**: この演習は非推奨です。 <https://learn.microsoft.com/azure/ai-services/language-service/question-answering/quickstart> のクイック スタート チュートリアルを確認することを検討してください
...
> **注意**  
> **BadArgument 無効な入力**エラーが発生した場合は、解決策として次の手順に従ってください。
>
> - 新しいブラウザー タブで FAQ ページを開きます。  
>   `https://learn.microsoft.com/en-us/training/support/faq?pivots=general`
> - 左下のパネルで、**[PDF のダウンロード]** ボタンを探します。
> - Web ページの PDF ビューが表示されます。 印刷オプションを選択します (または `Ctrl+P` / `Cmd+P` キーを押します)。
> - 印刷ダイアログで、プリンターとして **[PDF として保存]** を選択し、**[ページ 1–4]** を選択します (これらのページには、必要な FAQ コンテンツが含まれます)。
> - ファイルをローカルに保存します。
> - **[ソースの管理]** ページに戻り、**[+ ソースの追加]** を選択し、**[ファイル]** を選択します。
> - **[+ ファイルの追加]** を選択し、名前として「`Learn FAQ Page`」と入力し、保存した PDF をアップロードして、**[すべて追加]** を選択します。
